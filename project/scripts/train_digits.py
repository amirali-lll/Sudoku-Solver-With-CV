...
def parse_args():
    ...
    # Increased default synthetic samples for more robust printed digit recognition
    parser.add_argument("--synthetic-samples-per-class", type=int, default=5000)
    parser.add_argument("--data-dir", type=str, default="data")
    parser.add_argument("--hoda-path", type=str, required=True, help="Path to HODA .npz/.npy/.mat/.pkl export")
    parser.add_argument("--font-dir", type=str, default="fonts", help="Directory containing .ttf fonts")
